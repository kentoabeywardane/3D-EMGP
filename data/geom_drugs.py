...
import sys
# have to comment out to allow global filepaths
sys.path.append('.')
...
def gen_GEOM_blocks(base_path, datasets, output_dir, conf_per_mol=10, val_num = 200, train_block_size = 100000, workers = 1, seed=None, test_mask=None, train_smiles=None):
    ...
    # Kento edit 11/3 due to failure --> I believe that train_idx overshoots num train_data so 
    # shuffling this creates a "index out of range" error with idx2list
